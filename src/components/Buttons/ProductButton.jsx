...
const ProductButtons = memo(({ product, activeSize, setActiveSize }) => {
  ...
  const [currentModificationAmount, setCurrentModificationAmount] = useState(product.amount)
  ...
  return(
    <ProductItemWrapper style={{overflow: "hidden"}}>
      <SizeButtons modificatorUknow={modificatorUknow} modifications={product.modifications} activeSize={activeSize} setActiveSize={setActiveSize} />
